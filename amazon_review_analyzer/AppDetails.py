...
def graphicspath():
    return render_template(
        'graphicsreview.html',user_image = full_filename,
...
def controlpath():
    return render_template(
        'controlreview.html',user_image = full_filename,
...
def powerconsumepath():
    return render_template(
        'powerconsumereview.html',user_image = full_filename,
...
def userfriendlypath():
    return render_template(
        'userfriedlyreviewshow.html',user_image = full_filename,
...
def advertisementpath():
    return render_template(
        'advertisereview.html',user_image = full_filename,
...
def crashpath():
    return render_template(
        'crashreview.html',user_image = full_filename,
...
def hello_world():
   ...
   # return 'positive review : '+str(average_positive_sentiment)+'\n'+'negative review : '+str(average_negative_sentiment)
    return render_template(
        'app_details.html', positive_senti=average_positive_sentiment,negative_senti=average_negative_sentiment,user_image = full_filename,graphicsupvote=graphics_upvote,graphicsdownvote=graphics_downvote,controlupvote=control_upvote,controldownvote=control_downvote,
